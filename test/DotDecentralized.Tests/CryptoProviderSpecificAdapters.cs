...
namespace DotDecentralized.Tests
{
    ...
    public static class CryptoProviderLoader
    {
        ...
        {
            //Some Visual Studio related assemblies throw ReflectionTypeLoadException, so
            //this simple filter is a temporary solution to that.
            return AppDomain.CurrentDomain.GetAssemblies()
                .Where(assembly => assembly?.FullName?.StartsWith("Microsoft.") == false)
